...
- [ ] Any instruction producing a temporary that is never consumed is eliminated
...
3. [ ] **Bootstrapping checklist**:
   - [ ] Compiler parses its own source without errors
   - [x] Generated code passes all tests identically to GCC build
   - [ ] Binary size comparable (compiler itself is optimized)
