...
/* ==================================================================
 * TEST 25: void function cannot return a value
 * ================================================================== */
static void test_void_return_value_error(void)
{
    const char *src =
        "void foo(void) {\n"
        "    return 42;\n"
    ...
    PASS("test_void_return_value_error");
    sema_destroy(s);
}

/* ==================================================================
 * TEST 26: non-void function must return a value
 * ================================================================== */
static void test_nonvoid_no_return_error(void)
{
    const char *src =
        "int bar(void) {\n"
        "    return;\n"
    ...
    PASS("test_nonvoid_no_return_error");
    sema_destroy(s);
}

/* ==================================================================
 * TEST 27: valid void function with bare return (no value)
 * ================================================================== */
static void test_void_bare_return_ok(void)
{
    const char *src =
        "void baz(void) {\n"
        "    return;\n"
    ...
    int ok = 0;
    SemaContext *s = parse_and_sema(src, &ok);
    assert(s && ok);  /* should succeed — void func, no return value */

    PASS("test_void_bare_return_ok");
    sema_destroy(s);
}

/* ==================================================================
 * TEST 28: valid non-void function with return value
 * ================================================================== */
static void test_nonvoid_return_value_ok(void)
{
    const char *src =
        "int qux(void) {\n"
        "    return 99;\n"
    ...
    int ok = 0;
    SemaContext *s = parse_and_sema(src, &ok);
    assert(s && ok);  /* should succeed — int func, has return value */

    PASS("test_nonvoid_return_value_ok");
    sema_destroy(s);
}
...
int main(void)
{
    ...
    test_lookup_missing();
    test_get_type_oob();
    test_void_return_value_error();
    test_nonvoid_no_return_error();
    test_void_bare_return_ok();
    test_nonvoid_return_value_ok();
